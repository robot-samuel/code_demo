...
(cl:defmethod cl:initialize-instance :after ((m <String>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'String)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dgvmsg-msg:<String> is deprecated: use dgvmsg-msg:String instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <String>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dgvmsg-msg:data-val is deprecated.  Use dgvmsg-msg:data instead.")
  (data m))
