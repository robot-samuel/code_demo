...
(cl:defmethod cl:initialize-instance :after ((m <Joy>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Joy)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dgvmsg-msg:<Joy> is deprecated: use dgvmsg-msg:Joy instead.")))
...
(cl:defmethod axes-val ((m <Joy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dgvmsg-msg:axes-val is deprecated.  Use dgvmsg-msg:axes instead.")
  (axes m))
