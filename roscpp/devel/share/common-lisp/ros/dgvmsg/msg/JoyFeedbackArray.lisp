...
(cl:defclass <JoyFeedbackArray> (roslisp-msg-protocol:ros-message)
  ((array
    :reader array
    :initarg :array
    :type (cl:vector dgvmsg-msg:JoyFeedback)
   :initform (cl:make-array 0 :element-type 'dgvmsg-msg:JoyFeedback :initial-element (cl:make-instance 'dgvmsg-msg:JoyFeedback))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <JoyFeedbackArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JoyFeedbackArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dgvmsg-msg:<JoyFeedbackArray> is deprecated: use dgvmsg-msg:JoyFeedbackArray instead.")))

(cl:ensure-generic-function 'array-val :lambda-list '(m))
(cl:defmethod array-val ((m <JoyFeedbackArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dgvmsg-msg:array-val is deprecated.  Use dgvmsg-msg:array instead.")
  (array m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <JoyFeedbackArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'array)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'dgvmsg-msg:JoyFeedback))
