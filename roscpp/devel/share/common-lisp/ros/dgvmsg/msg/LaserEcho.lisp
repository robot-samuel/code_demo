...
(cl:defmethod cl:initialize-instance :after ((m <LaserEcho>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LaserEcho)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dgvmsg-msg:<LaserEcho> is deprecated: use dgvmsg-msg:LaserEcho instead.")))

(cl:ensure-generic-function 'echoes-val :lambda-list '(m))
(cl:defmethod echoes-val ((m <LaserEcho>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dgvmsg-msg:echoes-val is deprecated.  Use dgvmsg-msg:echoes instead.")
  (echoes m))
