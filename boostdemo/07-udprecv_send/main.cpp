...
void can1_master(boost::shared_ptr<Cnet200> pa){
...
void can2_master(boost::shared_ptr<Cnet200> pa){
...
int main(int argc, char **argv)
{
    try{
        ...
        (1024));
        boost::shared_ptr<Cnet200> Ocnet200_can1(new Cnet200(service,local_can1,pcbbuffer));
        ...
        boost::circular_buffer<unsigned char> 
        (1024));
        boost::shared_ptr<Cnet200> Ocnet200_can2(new Cnet200(service,local_can2,pcbcan2buffer));
