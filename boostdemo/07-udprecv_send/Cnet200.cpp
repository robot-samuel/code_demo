...
Cnet200::Cnet200(boost::asio::io_service &io,
...
void Cnet200::recv_master(const boost::system::error_code& error,
        std::size_t bytes_transferred/*bytes_transferred*/){
...
std::string Cnet200::copyrecvbufer(){
